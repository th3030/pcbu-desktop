...
const std::map<std::string, std::string> g_EnLangMap = {
        ...
        {"error_account_disabled", "Error: This account is disabled."},
        ...
        {"unlock_error_connect_retry", "Could not connect to phone. Retrying..."},
        {"unlock_error_netdown", "Connection type not enabled."},
...
const std::map<std::string, std::string> g_DeLangMap = {
        ...
        {"error_account_disabled", "Fehler: Dieses Benutzerkonto ist deaktiviert."},
        ...
        {"unlock_error_connect_retry", "Verbindung zum Telefon fehlgeschlagen. Wiederholen..."},
        {"unlock_error_netdown", "Verbindungstyp deaktiviert."},
