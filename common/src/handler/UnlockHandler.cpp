    ...
    for(const auto& device : devices) {
        ...
        switch (device.pairingMethod) {
            ...
            case PairingMethod::BLUETOOTH:
                ...
                btConnection2 = new BTUnlockClient(device.bluetoothAddress, device, true);
                break;
        ...
        if(btConnection2) {
            btConnection2->SetUnlockInfo(authUser, authProgram);
            connections.emplace_back(btConnection2);
        }
    }
